...
def UttanasanaCheck(lmlist):
    if len(lmlist)>0:
            ...
            # print(knee_angle)
            if PoseSimilarityDetector.compare_poses(landmarks, lmlist, threshold=0.2):
                if knee_angle > 150:
                ...
                text = "Your are doing the wrong asana."
